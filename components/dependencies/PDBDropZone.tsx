...
interface DropzoneButtonImprovedProps {
  onPdbContentsChange: (contents: string[]) => void;
}

export function PDBDropZone(props: DropzoneButtonImprovedProps) {
      ...
      >
        ...
        <div style={{ pointerEvents: 'none' }}>
          ...
          <Text align="center" size="sm" mt="xs" color="dimmed">
            PDB(s) go here. Will be run combinatorially. So x PDBs and y ligands will be docked x*y
            times. Structure your uploads accordingly for screening.
          </Text>
        </div>
      </Dropzone>
